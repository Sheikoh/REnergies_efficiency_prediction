...
def load_data():
    # Datasets
    df_nat = pd.read_csv("../../data/prod/eCO2mix_RTE_Annuel-Definitif.csv")
    df_reg = pd.read_csv("../../data/prod/eCO2mix_RTE_Auvergne-Rhone-Alpes.csv")
...
# Sélection période (ofiltre par année)
...
with tab_ech:
    ...
    st.caption("A faire : ajouter les visualition détaillant les flux par pays / région")